...
const UPGRADES = {
	...
	"bomb_banger1": {
		"icon": WEAPON_PATH + "bomb_banger.png",
		"displayname": "Bomb Banger",
		"details": "Drops a bomb that detonates on contact and ticks damage.",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"bomb_banger2": {
		"icon": WEAPON_PATH + "bomb_banger.png",
		"displayname": "Bomb Banger",
		"details": "Improves Bomb Banger (cooldown).",
		"level": "Level: 2",
		"prerequisite": ["bomb_banger1"],
		"type": "weapon"
	},
	"bomb_banger3": {
		"icon": WEAPON_PATH + "bomb_banger.png",
		"displayname": "Bomb Banger",
		"details": "Improves Bomb Banger (more bombs).",
		"level": "Level: 3",
		"prerequisite": ["bomb_banger2"],
		"type": "weapon"
	},
	"bomb_banger4": {
		"icon": WEAPON_PATH + "bomb_banger.png",
		"displayname": "Ultimate Bomb Banger",
		"details": "Max Bomb Banger (more bombs + faster cooldown).",
		"level": "Level: 4",
		"prerequisite": ["bomb_banger3"],
		"type": "weapon"
	},
	"bone_smash1": {
		"icon": WEAPON_PATH + "bone_smash.png",
		"displayname": "Bone Smash",
		"details": "Smashes down on a target area, dealing repeated damage.",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"bone_smash2": {
		"icon": WEAPON_PATH + "bone_smash.png",
		"displayname": "Bone Smash",
		"details": "Improves Bone Smash (damage/speed).",
		"level": "Level: 2",
		"prerequisite": ["bone_smash1"],
		"type": "weapon"
	},
	"bone_smash3": {
		"icon": WEAPON_PATH + "bone_smash.png",
		"displayname": "Bone Smash",
		"details": "Improves Bone Smash (more smashes).",
		"level": "Level: 3",
		"prerequisite": ["bone_smash2"],
		"type": "weapon"
	},
	"bone_smash4": {
		"icon": WEAPON_PATH + "bone_smash.png",
		"displayname": "Ultimate Bone Smash",
		"details": "Max Bone Smash (more smashes + faster cooldown).",
		"level": "Level: 4",
		"prerequisite": ["bone_smash3"],
		"type": "weapon"
	},
	"javelin1": {
	...
	"xp_booster1": {
		"icon": ICON_PATH + "booster.png",
		"displayname": "XP Booster",
		"details": "Gain 10% more experience",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "upgrade"
	},
	"xp_booster2": {
		"icon": ICON_PATH + "booster.png",
		"displayname": "XP Booster",
		"details": "Gain 20% more experience",
		"level": "Level: 2",
		"prerequisite": ["xp_booster1"],
		"type": "upgrade"
	},
	"xp_booster3": {
		"icon": ICON_PATH + "booster.png",
		"displayname": "XP Booster",
		"details": "Gain 30% more experience",
		"level": "Level: 3",
		"prerequisite": ["xp_booster2"],
		"type": "upgrade"
	},
	"xp_booster4": {
		"icon": ICON_PATH + "booster.png",
		"displayname": "XP Booster",
		"details": "Gain 40% more experience",
		"level": "Level: 4",
		"prerequisite": ["xp_booster3"],
		"type": "upgrade"
	},
	"xp_booster5": {
		"icon": ICON_PATH + "booster.png",
		"displayname": "XP Booster",
		"details": "Gain 50% more experience",
		"level": "Level: 5",
		"prerequisite": ["xp_booster4"],
		"type": "upgrade"
	},
	"blood_oath1": {
